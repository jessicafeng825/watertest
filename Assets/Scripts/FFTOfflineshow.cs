...
public class FFTOfflineshow : MonoBehaviour
{
    ...
    void Update()
    {
        /*
        count %= 128;
        string filefordisplacement = string.Format("Textures/res/Displace/{0}",count);
        string filefornormal = string.Format("Textures/res/Normal/{0}",count);
        string fileforbubble = string.Format("Textures/res/Bubbles/{0}",count);//文件夹和贴图名

        //string file1 = "D:/unity project/watertest/Assets/Textures/shui1.png";
        SetTex(filefordisplacement,filefornormal,fileforbubble);
