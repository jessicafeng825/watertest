    ...
    SubShader
    {
		...
		#define APPLY_FOG 1  
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                fixed3 refrcol = RefrColfromRT(tmp13,i.uv2) * 5 * _LightColor0.rgb;
                float2 tmp14;
                ...
                float3 reflCol3 = oceanDiffuse * Reflect(i.ScreenPos,normal) * 5;
                ...
                float3 tmp7 = lerp(refrcol,reflCol3,fresnelReflectFactor1) + diffuse + specular ;
